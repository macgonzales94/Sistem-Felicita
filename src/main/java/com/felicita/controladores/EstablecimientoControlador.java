...
public class EstablecimientoControlador {
    ...
    @PostMapping("/nuevo")
    public String crearEstablecimiento(@Valid @ModelAttribute("establecimientoForm") EstablecimientoDTO establecimientoDTO,
    ...
    public String actualizarEstablecimiento(@PathVariable Long id,
        ...
        try {
            EstablecimientoDTO establecimientoActualizado = establecimientoServicio.actualizarEstablecimiento(id, establecimientoDTO);
